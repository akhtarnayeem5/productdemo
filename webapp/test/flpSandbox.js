		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "northwindcatalogue",
									"targetURL": "#btpconnectivityproductdemo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"btpconnectivityproductdemo-display": {
								"semanticObject": "btpconnectivityproductdemo",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=btp.connectivity.productdemo",
									"url": sap.ui.require.toUrl("btp/connectivity/productdemo")
								}
							}
						}
					}
